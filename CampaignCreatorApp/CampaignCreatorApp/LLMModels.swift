...
public let placeholderLLMs: [CampaignCreatorLib.AvailableLLM] = [
    .init(id: "gpt-4", name: "GPT-4", modelType: "openai", supportsTemperature: true, capabilities: ["text"]),
    .init(id: "gpt-3.5-turbo", name: "GPT-3.5 Turbo", modelType: "openai", supportsTemperature: true, capabilities: ["text"]),
    .init(id: "claude-3-opus", name: "Claude 3 Opus", modelType: "anthropic", supportsTemperature: true, capabilities: ["text"]),
    .init(id: "gemini-pro", name: "Gemini Pro", modelType: "google", supportsTemperature: true, capabilities: ["text"])
]
