...
revision = 'manual_003_reformat_chat_messages_json'  # Replace with actual ID generated by `alembic revision`
down_revision = None # e.g. 'manual_002_add_chat_messages_table' or your latest
branch_labels = None
depends_on = None
